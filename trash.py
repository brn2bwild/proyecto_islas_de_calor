...
GEE_LOCALITIES_ASSET = "projects/islas-calor-teapa-475319/assets/localidades_urbanas"

GEE_SERVICE_ACCOUNT = "gee-service-account@islas-calor-teapa.iam.gserviceaccount.com"
